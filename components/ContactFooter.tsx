...
export default function ContactFooter({ index = 0 }: ContactFooterProps) {
  return (
    ...
    >
      <motion.footer 
        className="w-full h-full p-8 bg-card rounded-[32px] border border-border/50 outline outline-12 outline-offset-[-12px] flex flex-col justify-start items-start gap-2.5"
        style={{
